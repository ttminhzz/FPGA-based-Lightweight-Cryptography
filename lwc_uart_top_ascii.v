...
module lwc_uart_top_ascii #(
    ...
    localparam [2:0] ST_RX_HEX   = 3'd1;
    localparam [2:0] ST_START    = 3'd2;
    localparam [2:0] ST_WAIT_CT  = 3'd3;
    localparam [2:0] ST_TX_RESP  = 3'd4;
    reg [2:0] state;
            ...
            case (state)
                ...
                ST_RX_HEX: begin
                    if (rx_valid) begin
                        ...
                        if ((rx_data == 8'h20) || (rx_data == 8'h0D) || (rx_data == 8'h0A) || (rx_data == 8'h09)) begin
                            state <= ST_RX_HEX;
